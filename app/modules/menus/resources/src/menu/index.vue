...
<div class="liro-menu-index" ref="el">
    ...
    <portal to="app-toolbar">
        <div class="uk-navbar-item">
            ...
            <!-- Type select -->
            <div class="uk-width-medium uk-margin-small-left">
    ...
    <div class="th-form is-table">
        <div class="th-table-fake uk-margin-remove-bottom">

            <!-- Table head -->
            <div class="th-table-fake-head">
                <div class="th-table-fake-tr uk-flex">
            ...
            <!-- Table body -->
            <div class="th-table-fake-body" v-if="menus.length != 0">
            ...
            <!-- Table footer -->
            <div class="th-table-fake-footer">
                <div class="th-table-fake-tr uk-flex">
