(function(global) {
    ...
    global.Shift = function() {
         ...
         * @param event {Object}
         */
        global.document.onkeyup = function(event) {
    ...
    global.Shift.prototype = {
        ...
        _getNodesByGroupName: function _getNodesByGroupName(groupName) {
            ...
            if (!groupName) {
                return global.document.querySelectorAll('*[data-shift-group]');
            }

            return global.document.querySelectorAll('*[data-shift-group="' + groupName + '"]');
