<template>
    <NLoader :visible="load" class="web-language-edit">
...
<script>
    export default {
        ...
        methods: {
            ...
            fetchEntity()
            {
                let route = this.Route.get('module.web-language.language.edit',
                    this.$route.params);
            ...
            updateEntity()
            {
                ...
                let route = this.Route.get('module.web-language.language.update',
                    this.$route.params);
