<html lang="{{ App::getLocale() }}">
    <head>
        ...
        @php
            Style::link('uikit.index', 'theme::dist/css/theme.css');
            echo Style::get();

            Script::link('uikit.index', 'theme::dist/js/theme.js');
            echo Script::get();
        @endphp
    </head>
    <body>
                    ...
                    <nav class="uk-navbar-container uk-container uk-container-expand uk-navbar-transparent" uk-navbar>
                        <div class="uk-navbar-left">
                            ...
                            <ul class="uk-navbar-nav">
                                <li>
                                    <a href="">{{ __('*.menu.menus') }}</a>
                                </li>
                                <li class="uk-active">
                                    <a href="">{{ __('*.language.languages') }}</a>
                                </li>
                                <li>
                                    <a href="">{{ __('*.user.users') }}</a>
                                </li>
                            </ul>
                        </div>
                        <div class="uk-navbar-right">
                            <ul class="uk-navbar-nav">
                                ...
                                <li>
                                    <a href=""></i>@lang('*.user.form.logout')</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
